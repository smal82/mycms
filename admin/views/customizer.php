...
<div class="customizer-layout">
        ...
        <div class="tab-content" id="tab-identita">
            ...
            <form method="POST" action="index.php?action=save_customizer" enctype="multipart/form-data" id="customizer-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="site_title" value="<?php echo htmlspecialchars($this->db->getSetting('site_title', 'Nexa CMS')); ?>" required>
                </div>
                
                <div class="form-group">
                    <label>Motto del Sito:</label>
                    <input type="text" name="site_motto" value="<?php echo htmlspecialchars($this->db->getSetting('site_motto', '')); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <small>Descrizione del tuo sito</small>
                </div>
    ...
    <button type="submit" class="btn" style="margin-bottom: 20px;">Salva</button>
        </form>
