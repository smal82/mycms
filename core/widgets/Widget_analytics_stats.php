            ...
            <div id="pages-tab-<?php echo $widgetId; ?>" class="tab-content">
                <?php if (!empty($topPages['rows'])): ?>
                    <ul class="analytics-list">
                        <?php foreach ($topPages['rows'] as $page): ?>
                        <li>
                            <div class="page-info">
                                <span class="page-path"><?php echo htmlspecialchars($page['dimensionValues'][0]['value']); ?></span>
                                <span class="page-views"><?php echo number_format($page['metricValues'][0]['value']); ?> visite</span>
                            </div>
                        </li>
                        <?php endforeach; ?>
                    </ul>
